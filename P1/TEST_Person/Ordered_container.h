...
/*
Ordered_container provides a general-purpose ordered container facility, encapsulated (wrapped) in such a way
...
the data object pointed to by data_ptr. For example, arg_ptr could point to a data object containing the same value
as a member of the sought-for data object. This type is equivalent to OC_comp_fp_t,
but has its own name to clarify that the arg object might not be the same type as an item in the container. */
